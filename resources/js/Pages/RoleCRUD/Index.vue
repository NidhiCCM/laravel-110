...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">RolesCRUD</h2>
        </template>
        <div class="py-12">
                                    ...
                                    <tr v-for="role in roles.data" :key="role.id">
                                        ...
                                        <td class="border px-4 py-2 w-20">
                                            <Link class="px-4 py-2 text-sm text-white bg-blue-500 rounded"
                                                :href="route('rolesCRUD.edit', role.id)">
                                            Edit
                                            </Link>
                                            <Link class="mx-2 px-4 py-2 text-sm text-white bg-blue-500 rounded"
                                                :href="route('rolesCRUD.show', role.id)">
                                            Show
                                            </Link>
